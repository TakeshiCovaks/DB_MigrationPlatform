 ...
 */
@Printer(typeMeta = TypeMeta.VIEWS)
public class ViewsPrinter implements Printers {

    private static final Logger LOG = Logger.getLogger(ViewsPrinter.class);
    ...
    public String print(TreeNode node, Map<String, Printers> mapInstance) {
        LOG.debug("Views " + bundle.getString("notHaveDDL"));
        return "Views " + bundle.getString("notHaveDDL");
    }
}
